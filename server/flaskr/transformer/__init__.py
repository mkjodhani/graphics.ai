...
class TransformImage(object):
    ...
    def tranform(self):
        ...
        output_fname = "server/public/images/converted/" + fname + " preview."+extension
        ...
        cv2.imwrite("server/public/images/converted/" + fname + "bg_blurred."+extension, output)

        '''creating style transfer'''
        output = self.bg_style_transfer(self.bg_filename, numpy.shape(self.mask), self.img)
        cv2.imwrite("server/public/images/converted/" + fname + "style_transfer."+extension, output)
